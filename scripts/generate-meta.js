...
if (fs.existsSync(indexPath)) {
    ...
    html = html.replace(
        /href="\/android-chrome/g,
        'href="https://dinqor.cn/android-chrome',
    );
    html = html.replace(
        /href="\/apple-touch/g,
        'href="https://dinqor.cn/apple-touch',
    );
    html = html.replace(
        /content="\/og-image/g,
        'content="https://dinqor.cn/og-image',
    );
    html = html.replace(
        /content="\/twitter-image/g,
        'content="https://dinqor.cn/twitter-image',
    );
    html = html.replace(
        /content="\/logo-512/g,
        'content="https://dinqor.cn/logo-512',
    );
...
console.log("\n📋 Next steps:");
console.log(
    "1. Test social media preview: https://developers.facebook.com/tools/debug/",
);
