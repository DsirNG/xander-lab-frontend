...
const SingleFileTransferDemo = React.lazy(
    () => import("./pages/demos/SingleFileTransferDemo"),
);
const MultiFileTransferDemo = React.lazy(
    () => import("./pages/demos/MultiFileTransferDemo"),
);
const KanbanDemo = React.lazy(() => import("./pages/demos/KanbanDemo"));
const LayoutBuilderDemo = React.lazy(
    () => import("./pages/demos/LayoutBuilderDemo"),
);
