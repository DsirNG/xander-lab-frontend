                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {folders.map((folder) => (
                            <div
                                ...
                                onPointerUp={(e) =>
                                    dragDrop.handleDrop(folder, e)
                                }
                                className={`relative p-6 rounded-[2rem] border-2 transition-all duration-500 flex flex-col min-h-[220px] ${
                            ...
                            >
                                <div className="pointer-events-none flex flex-col h-full">
                                    ...
                                    <div
                                        className={`font-bold text-sm mb-1 ${dragDrop.dragOverItem?.id === folder.id ? "text-sky-600" : "text-slate-700 "}`}
                                    >
                                        {folder.name}
                                    </div>
                                    <div className="text-[10px] text-slate-400 mb-4">
                                        {folder.items.length} files stored
                                    </div>
