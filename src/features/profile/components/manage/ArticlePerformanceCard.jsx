    ...
    return (
        <div className="flex flex-col shrink-0 rounded-[20px] bg-white p-5 shadow-sm min-h-[220px]">
            <div className="text-base font-bold text-ink mb-4">
                {t("blogManage.performance", "发布表现")}{" "}
                <span className="text-sm font-normal text-ink-muted">
                    ({t("blogManage.recent7Days", "近7天")})
                </span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 mb-6">
                ...
                <div>
                    <div className="text-xs text-ink-muted mb-1">
                        {t("blogManage.stats.engagement", "互动率")}
                    </div>
                    <div className="text-xl font-bold text-ink mb-0.5">
                        3.21%
                    </div>
            ...
            <div className="relative h-[80px] w-full mt-auto">
                ...
                >
                    ...
                    {/* Area fill */}
                    <path
                        d="M 0 50 C 30 50, 40 30, 60 40 S 90 20, 110 30 S 140 10, 160 20 S 190 30, 210 20 S 240 50, 260 40 S 290 30, 300 20 L 300 80 L 0 80 Z"
                        fill="url(#chart-gradient)"
                    />

                    {/* Line */}
                    <path
                        d="M 0 50 C 30 50, 40 30, 60 40 S 90 20, 110 30 S 140 10, 160 20 S 190 30, 210 20 S 240 50, 260 40 S 290 30, 300 20"
                        fill="none"
                        stroke="#6366f1"
                        strokeWidth="2"
                        strokeLinecap="round"
