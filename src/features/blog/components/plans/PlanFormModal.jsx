                ...
                <div className="space-y-5">
                    ...
                    <FormField label={t("blogPlans.triggerTime")}>
                        ...
                        >
                            ...
                            <TimeInput
                                ...
                                onChange={(e) =>
                                    updateForm("triggerTime", e.target.value)
                                }
                            />
                            <TimezoneSelect
                                size="sm"
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <FormField label={t("blogPlans.tone")}>
                            <input
                                ...
                                maxLength={60}
                                onChange={(e) =>
                                    updateForm("tone", e.target.value)
                                }
                            ...
                            {[
                                ...
                                >
                                    <input
                                        ...
                                        onChange={(e) =>
                                            updateForm(field, e.target.checked)
                                        }
                    ...
                    <label className="flex cursor-pointer items-center gap-3 text-body text-ink-secondary">
                        <input
                            ...
                            onChange={(e) =>
                                updateForm("autoPublish", e.target.checked)
                            }
                            className="h-4 w-4 rounded border-border text-accent focus:ring-accent"
                        />
