                ...
                <ul className="space-y-1">
                    ...
                    {categories.map((cat) => (
                        <li key={cat.id}>
                            ...
                            >
                                <span>{cat.name}</span>
                                <span className={`text-micro font-medium px-1.5 py-0.5 rounded-full transition-colors ${activeCategory === cat.id
                ...
                <div className="flex flex-wrap gap-1.5">
                    {popularTags.map((tag) => {
                        ...
                        return (
                            ...
                            >
                                <span>{tag.name}</span>
                                <span className={`text-micro ${isActive ? 'text-white/70' : 'text-ink-faint'}`}>
                                    {tag.count}
                                </span>
                            </Link>
                        );
