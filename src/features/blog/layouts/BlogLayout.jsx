...
const BlogLayout = () => {
    ...
    return (
        <div className="bg-canvas">
            ...
            <div
                className={`mx-auto flex flex-col lg:flex-row overflow-hidden transition-all duration-300 ${
                    isPureReading
            ...
            >
                ...
                <main
                    className={`flex-grow overflow-y-auto custom-scrollbar w-full min-w-0 ${
                        isPureReading
