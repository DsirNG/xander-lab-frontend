...
export const blogService = {
    ...
    getPublishStatus: (requestId, config) =>
        get(`${BASE}/posts/publish-status`, { requestId }, config),
    ...
    getMyBlogById: (id, config) =>
        get(`${BASE}/posts/mine/${id}`, undefined, config),

    /** POST /api/blog/posts/{id}/sync/csdn */
    syncToCsdn: (id, config) =>
        post(`${BASE}/posts/${id}/sync/csdn`, undefined, config),

    /** POST /api/blog/posts/{id}/sync/juejin */
    syncToJuejin: (id, config) =>
        post(`${BASE}/posts/${id}/sync/juejin`, undefined, config),

    /** PUT /api/blog/posts/{id} */
    updateBlog: (id, blogData, config) =>
        put(`${BASE}/posts/${id}`, blogData, config),
    ...
    softDeleteBlog: (id, config) =>
        del(`${BASE}/posts/${id}`, undefined, config),
