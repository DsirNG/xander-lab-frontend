...
describe("blogService 端点映射", () => {
    ...
    it("单品查询与同步", () => {
        ...
        expect(apiMock.get).toHaveBeenCalledWith(
            "/api/blog/posts/mine/5",
            undefined,
            undefined,
        );
        blogService.syncToCsdn(5);
        expect(apiMock.post).toHaveBeenCalledWith(
            "/api/blog/posts/5/sync/csdn",
            undefined,
            undefined,
        );
        blogService.syncToJuejin(5);
        expect(apiMock.post).toHaveBeenCalledWith(
            "/api/blog/posts/5/sync/juejin",
            undefined,
            undefined,
        );
    });
    ...
    it("浏览端列表、分类、标签", () => {
        ...
        expect(apiMock.get).toHaveBeenCalledWith(
            "/api/blog/tags/popular",
            { limit: 8 },
            undefined,
        );
        blogService.recordView(9);
        expect(apiMock.post).toHaveBeenCalledWith(
            "/api/blog/posts/9/view",
            undefined,
            undefined,
        );
    });
