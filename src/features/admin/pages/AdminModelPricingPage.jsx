    ...
    const columns = [
        {
            ...
            render: (price) => (
                <div className="min-w-0">
                    ...
                    {price.remark ? (
                        <div
                            className="mt-0.5 truncate text-micro text-ink-faint"
                            title={price.remark}
                        >
                            {price.remark}
                        </div>
        ...
        priceColumn(
            "cachedWriteMilliPer1kToken",
            "admin.pricing.cachedWritePrice",
        ),
        {
            key: "enabled",
            ...
            render: (price) => (
                ...
                >
                    {price.enabled
                        ? t("admin.pricing.statusEnabled")
                        : t("admin.pricing.statusDisabled")}
                </span>
            ),
        },
        {
