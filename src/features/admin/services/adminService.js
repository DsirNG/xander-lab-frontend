...
export const adminService = {
    ...
    listProviders: (config) =>
        get("/api/admin/model-providers", undefined, config),
    createProvider: (payload, config) =>
        post("/api/admin/model-providers", payload, config),
    ...
    deleteProvider: (id, config) =>
        del(`/api/admin/model-providers/${id}`, undefined, config),

    /* ---------- 功能模型配置（主模型 + 兜底模型） ---------- */
    listFeatureConfigs: (config) =>
        get("/api/admin/feature-model-configs", undefined, config),
    ...
    listModelPrices: (config) =>
        get("/api/admin/billing/model-prices", undefined, config),
    upsertModelPrice: (model, payload, config) =>
        put(
            `/api/admin/billing/model-prices/${encodeURIComponent(model)}`,
            payload,
            config,
        ),
    ...
    getWechatCredential: (config) =>
        get("/api/admin/wechat-credential", undefined, config),
    saveWechatCredential: (payload, config) =>
