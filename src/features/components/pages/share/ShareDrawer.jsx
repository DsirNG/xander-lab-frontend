...
const ShareDrawer = ({
    ...
    return (
        <div className={`absolute bottom-0 left-0 right-0 bg-canvas border-t border-border z-[70] transition-all duration-350 shadow-[0_-20px_50px_rgba(0,0,0,0.06)] flex flex-col ${drawerOpen ? 'h-[60vh] md:h-[50vh] lg:h-[550px]' : 'h-14'}`}>
            <div className="h-14 flex-shrink-0 flex items-center justify-between px-4 lg:px-10 border-b border-border">
                <div className="flex items-center gap-3 lg:gap-10 h-full">
                    <div className="hidden lg:flex items-center gap-2 text-ink-faint">
                        ...
                        <span className="text-micro font-black uppercase tracking-[0.2em] italic">{t('components.share.drawer.coreArchitecture')}</span>
                    </div>
