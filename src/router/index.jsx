...
const ModuleList = React.lazy(
    () => import("@features/modules/pages/ModuleList"),
);
const ModuleContent = React.lazy(
    () => import("@features/modules/pages/ModuleContent"),
);
const ComponentList = React.lazy(
    () => import("@features/components/pages/ComponentList"),
);
const ComponentDetailWrapper = React.lazy(
    () => import("@features/components/pages/ComponentDetailWrapper"),
);
const ComponentShare = React.lazy(
    () => import("@features/components/pages/ComponentShare"),
);
...
const BlogPublish = React.lazy(
    () => import("@features/blog/pages/BlogPublish"),
);
const AgentChat = React.lazy(() => import("@features/agent/pages/AgentChat"));
const AgentSharedView = React.lazy(
    () => import("@features/agent/pages/AgentSharedView"),
);
const BlogPlans = React.lazy(() => import("@features/blog/pages/BlogPlans"));
const BlogPlanDetail = React.lazy(
    () => import("@features/blog/pages/BlogPlanDetail"),
);
const LoginPage = React.lazy(() => import("@features/auth/pages/LoginPage"));
const StudioPage = React.lazy(
    () => import("@features/studio/pages/StudioPage"),
);
const ProjectUploadPage = React.lazy(
    () => import("@features/studio/pages/ProjectUploadPage"),
);
const ComponentUploadPage = React.lazy(
    () => import("@features/studio/pages/ComponentUploadPage"),
);
const CompilerPage = React.lazy(
    () => import("@features/studio/pages/CompilerPage"),
);
const PublicSourcePage = React.lazy(
    () => import("@features/studio/pages/PublicSourcePage"),
);
const Img2ThreePage = React.lazy(
    () => import("@features/img2three/pages/Img2ThreePage"),
);
const WorkspaceLayout = React.lazy(
    () => import("@features/workspace/WorkspaceLayout"),
);
...
const EmailRemindersPage = React.lazy(
    () => import("@features/workspace/pages/EmailRemindersPage"),
);
...
const AdminModelProvidersPage = React.lazy(
    () => import("@features/admin/pages/AdminModelProvidersPage"),
);
const AdminModelPricingPage = React.lazy(
    () => import("@features/admin/pages/AdminModelPricingPage"),
);
const AdminFeatureModelConfigsPage = React.lazy(
    () => import("@features/admin/pages/AdminFeatureModelConfigsPage"),
);
