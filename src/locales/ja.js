...
export default {
  ...
  profile: {
    ...
    emailReminders: {
      ...
      emptyHint: '右側にメッセージを入力し、送信時刻を選択してください。',
      addTitle: '予約メールを追加',
      ...
      previewTitle: 'HTML メールプレビュー',
      safePreview: '安全なプレビュー',
      previewSubject: 'メールの件名がここに表示されます',
      previewMessage: 'メッセージは読みやすい HTML メールとして整形されます。',
      htmlSafetyHint: 'システムテンプレートでメールを生成します。入力はプレーンテキストとして扱われ、HTML やスクリプトは実行されません。',
      create: '予約タスクを作成',
      creating: '作成中…',
