...
export default {
  ...
  blog: {
    ...
    media: { insertImage: '画像を挿入', dropImage: '画像・GIF をドロップまたは選択し、カーソル位置に挿入します。', uploadingImage: 'アップロード中', imageInserted: '本文に画像を挿入しました', imageUploadFailed: '画像をアップロードできませんでした。もう一度お試しください。', invalidImage: '画像または GIF ファイルを選択してください', imageTooLarge: '画像は 10MB 以下にしてください', altText: '画像の説明', addToArticle: '本文に挿入' },
    editor: { addBlock: 'ブロックを追加', text: 'テキスト', h1: 'H1', h2: 'H2', todo: 'To-do', list: 'リスト', quote: '引用', code: 'コード', insertContent: 'コンテンツを挿入', imageGif: '画像 / GIF', video: '動画（近日対応）', divider: '区切り線', table: '表', codeBlock: 'コードブロック', quoteBlock: '引用ブロック' },
    agent: {
      title: 'ブログエージェント', back: 'ブログに戻る', headline: 'アイデアを公開可能な記事に', description: 'テーマまたは日記を入力してください。エージェントが調査、執筆、検証を行い、出典付きの記事を作成します。', inputLabel: 'テーマまたは日記', inputPlaceholder: '考え、経験、気づきを入力してください…', inputType: '入力タイプ', audience: '読者', tone: '文体', defaultAudience: 'このテーマに関心のある読者', defaultTone: '明快で誠実、実用的', generate: '調査して執筆', running: '調査・執筆中…', waiting: '入力待ち', ready: 'レビュー待ち', failed: 'エージェントはこのタスクを完了できませんでした', complete: '記事をレビューできます', workflow: 'エージェントの流れ', guardrail: '個人の経験は著者の経験として扱います。外部の主張には追跡可能な出典が必要で、自動公開はされません。', stages: { analyze: '記事の方向を決める', research: '調査と検証', write: '記事を執筆', review: '公開前レビュー' }, stageDescriptions: { analyze: '読者、視点、情報不足を整理します。', research: '外部の主張をウェブで検証します。', write: '完全な Markdown 記事を作成します。', review: '根拠と明瞭さを確認します。' }, article: '生成された記事', toDraft: 'エディターで開く', draftCreated: '下書きを作成しました。編集して公開できます。', sources: '調査ソース', noSources: '外部ソースは保存されていません。', review: '編集レビュー', reviewPending: '完了後にレビューが表示されます。', inputRequired: 'まずテーマまたは日記を入力してください。', contentFocus: '内容の範囲', mustCover: '記事の主題', relatedExpansion: '直接の補足', outOfScope: '追加しない内容', knowledgeGraph: '知識関係グラフ'
    }
  },
  common: {
    backHome: 'ホームに戻る',
