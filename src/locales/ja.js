...
export default {
  ...
  blog: {
    ...
    agent: {
      ...
      processing: '処理中 {{duration}}', processed: '処理済み {{duration}}', processedDone: '処理済み', processFailed: '処理に失敗しました', openPreview: 'クリックしてプレビュー', previewEmpty: '左側の生成記事を選択してプレビュー', untitled: '無題の記事', newTask: '新しいタスク', restoring: 'エージェントタスクを復元中…', singleTurnHint: 'このターンは完了しました。別の記事を書くには新しいタスクを開始してください。', inputLockedPlaceholder: 'このターンは終了しました。新しいタスクを開始してください。', confirmPublish: '公開する', viewArticle: '記事を見る', showMeta: '調査とレビューを表示', hideMeta: '調査とレビューを隠す'
    }
  },
  common: {
    backHome: 'ホームに戻る',
