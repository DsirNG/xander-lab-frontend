...
export default {
  ...
  profile: {
    ...
    account: 'ログイン中のアカウント',
    comingSoon: '近日公開',
    comingSoonHint: 'このモジュールは準備中です。まずは予約メールで自動リマインダーを管理できます。',
    nav: {
      account: 'アカウント情報',
      security: 'セキュリティ',
      notifications: '通知設定',
    ...
    emailReminders: {
      ...
      plainContentHint: 'プレーンテキストは選択したテンプレートで整形され、改行は保持されます。',
      htmlContentHint: 'HTML は選択したテンプレート内で描画されます。スクリプトや危険なタグは除去されます。',
      plainPreviewBadge: 'プレーンテキスト',
      htmlPreviewBadge: 'HTML 描画',
      htmlSafetyHint: 'プレーンテキストと HTML に対応し、複数テンプレートから選べます。',
      create: '予約メールを作成',
