...
export default {
  ...
  admin: {
    ...
    configs: {
      ...
      apiStyleChat: 'API chat /chat/completions',
      apiStyleResponses: 'API Responses /responses',
      apiStyleHint: 'Cùng một mô hình ở mỗi nhà cung cấp có thể dùng dạng API khác nhau; sinh ảnh nên chọn API chat (dòng gpt-image)',
