...
export default {
  ...
  blog: {
    ...
    agent: {
      ...
      processing: 'Đang xử lý {{duration}}', processed: 'Đã xử lý {{duration}}', processedDone: 'Đã xử lý', processFailed: 'Xử lý thất bại', openPreview: 'Nhấn để xem trước', previewEmpty: 'Chọn blog đã tạo bên trái để xem trước', untitled: 'Bài viết chưa có tiêu đề', newTask: 'Nhiệm vụ mới', restoring: 'Đang khôi phục nhiệm vụ…', singleTurnHint: 'Lượt này đã xong. Hãy bắt đầu nhiệm vụ mới để viết bài khác.', inputLockedPlaceholder: 'Lượt này đã kết thúc. Hãy bắt đầu nhiệm vụ mới.', confirmPublish: 'Xuất bản', viewArticle: 'Xem bài viết', showMeta: 'Hiện nghiên cứu và rà soát', hideMeta: 'Ẩn nghiên cứu và rà soát'
    }
  },
  common: {
