...
export default {
  ...
  profile: {
    ...
    emailReminders: {
      ...
      plainContentHint: 'Văn bản thuần được bọc trong mẫu đã chọn; xuống dòng được giữ.',
      htmlContentHint: 'HTML được render trong mẫu đã chọn; script và thẻ nguy hiểm bị lọc.',
      plainPreviewBadge: 'Văn bản thuần',
      htmlPreviewBadge: 'Render HTML',
      htmlSafetyHint: 'Hỗ trợ văn bản thuần và HTML, kèm nhiều mẫu bố cục.',
