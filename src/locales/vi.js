...
export default {
  ...
  blog: {
    ...
    agentChat: {
      ...
      planTitle: 'Kế hoạch công việc', planPending: 'Chờ làm', planInProgress: 'Đang làm', planDone: 'Hoàn thành', planDropped: 'Đã bỏ',
      reflectionTitle: 'Tự kiểm tra', reflectionRound: 'Tự kiểm tra · lượt {{round}}',
  ...
  blogPlans: {
    ...
    overview: 'Tổng quan kế hoạch', totalPlans: 'Tổng số', activePlans: 'Sắp chạy', pausedPlans: 'Đã tạm dừng', completedPlans: 'Hoàn thành', publishRhythm: 'Nhịp đăng bài', localDailyPublish: 'Số bài đăng mỗi ngày trên trang', postsPerDay: 'bài/ngày', upcomingToday: 'Thực hiện hôm nay', noUpcomingToday: 'Hôm nay không có kế hoạch cần chạy',
  ...
  workspace: {
    ...
    home: {
      ...
      subtitle: 'Không gian AI và tri thức cá nhân để bạn liên tục học hỏi và sáng tạo.',
      prompt: 'Hãy nói với DinQor điều bạn muốn làm...',
      actions: {
        chat: { title: 'Trò chuyện với agent', description: 'Trò chuyện cùng bản sao tri thức' },
        import: { title: 'Nhập kiến thức', description: 'Nhập tài liệu hoặc liên kết' },
      ...
      stats: { knowledge: 'Điểm kiến thức', reviews: 'Cần ôn tập', studyTime: 'Thời gian học hôm nay', hours: 'giờ', articles: 'Bài đã đăng', articlesUnit: 'bài', compared: 'so với hôm qua' },
      todos: { title: 'Việc cần làm và nhắc nhở', items: { closure: 'Ôn “Phạm vi và closure trong JS”', notes: 'Hoàn thành ghi chú kỹ thuật frontend', websocket: 'Đăng “Thực hành WebSocket tốt nhất”', dailyStudy: 'Điểm danh học tập hằng ngày', knowledgeUpdate: 'Cập nhật kiến thức: phương pháp sản phẩm AI' } },
      suggestions: {
        title: 'Gợi ý AI',
        refresh: 'Đổi gợi ý',
        items: {
          review: { title: 'Nhắc lịch ôn tập', description: 'Sáu điểm kiến thức sắp bước vào giai đoạn dễ quên. Hãy ôn lại hôm nay.', action: 'Ôn ngay' },
          path: { title: 'Lộ trình học tập', description: 'Lộ trình tối ưu hiệu năng frontend phù hợp với đồ thị kiến thức của bạn.', action: 'Xem lộ trình' },
          inspiration: { title: 'Ý tưởng blog', description: 'Bạn vừa nghiên cứu WebSocket. Hãy so sánh nó với long polling.', action: 'Bắt đầu viết' },
        },
      },
      meta: { yesterday: 'Hôm qua', todayTime: 'Hôm nay 20:00', tomorrowTime: 'Ngày mai 10:00', completed: 'Đã hoàn thành' },
    },
  ...
  profile: {
    ...
    account: {
      ...
      avatarInvalid: 'Định dạng hoặc kích thước ảnh đại diện không hợp lệ',
  ...
  knowledge: {
    loadErrorTitle: 'Không thể tải kho kiến thức', loadErrorHint: 'Kho kiến thức tạm thời không khả dụng. Hãy kiểm tra kết nối và thử lại.', retry: 'Tải lại', staleDataWarning: 'Làm mới thất bại. Dữ liệu tải thành công gần nhất vẫn đang được hiển thị.', attemptPollError: 'Hiện chưa thể làm mới tác vụ ghi âm. Hệ thống chỉ thử lại hữu hạn và tác vụ vẫn được lưu.', retryAttempt: 'Thử lại ngay',
    title: 'Gương kiến thức cá nhân', subtitle: 'Theo dõi điều cần học, bằng chứng làm chủ và lịch ôn tập.', add: 'Thêm kiến thức', loading: 'Đang tải gương kiến thức…', created: 'Đã thêm kiến thức', createTitle: 'Thêm kiến thức cần nắm', create: 'Thêm vào thư viện', empty: 'Bắt đầu với kiến thức đầu tiên', emptyHint: 'Thêm nội dung nguồn để theo dõi mức độ làm chủ theo thời gian.', library: 'Kiến thức của tôi', mastery: 'Mức độ làm chủ', original: 'Nội dung gốc', originalHidden: 'Nội dung gốc đã được ẩn. Hãy đọc lại từ trí nhớ.', reviewCount: 'Đã kiểm tra {{count}} lần', audioTest: 'Kiểm tra đọc thuộc', audioHint: 'Đọc lại từ trí nhớ. AI sẽ chuyển giọng nói và so sánh với bản gốc.', start: 'Bắt đầu ghi âm', stop: 'Dừng và kiểm tra', recording: 'Đang ghi âm…', microphoneUnavailable: 'Không thể dùng micrô. Hãy dùng HTTPS hoặc kiểm tra cài đặt.', permissionTitle: 'Cho phép dùng micrô', permissionHint: 'Bài kiểm tra cần ghi âm giọng nói. Trình duyệt sẽ hỏi quyền sau khi bạn tiếp tục.', permissionBlockedHint: 'Quyền micrô đã bị từ chối. Hãy cho phép từ biểu tượng quyền cạnh thanh địa chỉ.', permissionPrivacy: 'Âm thanh chỉ dùng để chuyển lời và chấm mức độ. Ứng dụng không ghi âm ngầm.', allowMicrophone: 'Đồng ý và cho phép', agentTest: 'Kiểm tra bằng trợ lý', agentTestHint: 'Trợ lý sẽ đặt câu hỏi từ kiến thức này, chấm từng câu trả lời của bạn và cập nhật mức thông thạo.', askAgentToQuiz: 'Nhờ trợ lý kiểm tra tôi', quizPrompt: 'Hãy kiểm tra tôi về «{{title}}» (ID kiến thức: {{materialId}}). Gọi quiz_knowledge bằng đúng ID này, đặt vài câu hỏi rồi chấm từng câu sau khi tôi trả lời.', noQuizYet: 'Chưa có lần kiểm tra nào. Sau lần đầu tiên, điểm và phần chấm từng câu sẽ hiện ở đây.', quizAt: 'Thời điểm kiểm tra', yourAnswer: 'Câu trả lời của bạn', creditFull: 'Đúng', creditPartial: 'Đúng một nửa', creditNone: 'Sai', latestResult: 'Lần kiểm tra gần nhất', score: 'Độ chính xác', correct: 'Đúng', missing: 'Thiếu', wrong: 'Sai', transcript: 'Bản chuyển lời', nextReview: 'Gợi ý ôn lại: {{time}}',
    edit: 'Sửa', editTitle: 'Sửa kiến thức này', save: 'Lưu thay đổi', updated: 'Đã lưu thay đổi', editResetHint: 'Sửa nội dung hoặc loại kiến thức sẽ đưa mức thành thạo về 0 và xếp lại lịch ôn; chỉ sửa dấu câu hay khoảng trắng thì không ảnh hưởng.', archive: 'Lưu trữ', restore: 'Phục hồi', archived: 'Đã lưu trữ — không còn xuất hiện trong danh sách hằng ngày và hàng đợi ôn tập', restored: 'Đã phục hồi vào thư viện', archivedNotice: 'Kiến thức này đã lưu trữ: không vào hàng đợi ôn tập và trợ lý cũng không hỏi bạn về nó.', archivedEmpty: 'Chưa có kiến thức nào được lưu trữ', archivedEmptyHint: 'Kiến thức đã lưu trữ nằm ở đây và có thể phục hồi bất cứ lúc nào.', delete: 'Xoá', deleteTitle: 'Xoá kiến thức này?', deleteConfirm: 'Xoá vĩnh viễn', deleteWarning: '“{{title}}” cùng các bản ghi âm và lịch sử kiểm tra sẽ bị xoá, không thể phục hồi.', deleteArchiveHint: 'Chỉ tạm chưa muốn học? Hãy lưu trữ, nội dung vẫn được giữ nguyên.',
  ...
  admin: {
    ...
    users: {
      ...
      subtitle: 'Tìm kiếm, cấm hoặc mở cấm tài khoản. Người bị cấm sẽ mất ngay toàn bộ phiên đăng nhập.',
      ...
      banMessage: 'Cấm {{name}}? Toàn bộ phiên đăng nhập sẽ bị thu hồi ngay lập tức.',
    ...
    providers: {
      ...
      subtitle: 'Quản lý các điểm cuối mô hình. Khóa API được mã hóa và không hiển thị lại.',
      ...
      baseUrl: 'URL gốc',
      apiKey: 'Khóa API',
      apiKeyHint: 'Được lưu mã hóa; không hiển thị trong UI hay phản hồi API.',
    ...
    pricing: {
      ...
      subtitle: 'Quản lý đơn giá tính phí token theo mô hình; mô hình chưa cấu hình sẽ dùng giá mặc định của máy chủ.',
      add: 'Thêm định giá',
      ...
      deleteMessage: 'Xóa định giá của {{name}}? Tính phí cho mô hình này sẽ về giá mặc định của máy chủ.',
      ...
      emptyHint: 'Sau khi thêm, tính phí sẽ khớp chính xác theo tên mô hình; mô hình khác dùng giá mặc định',
    },
    wechatCredential: {
    ...
    configs: {
      ...
      subtitle: 'Chọn mô hình chính và dự phòng cho từng chức năng. Chức năng chưa cấu hình tiếp tục dùng biến môi trường.',
      ...
      apiStyleChat: 'API chat /chat/completions (messages+modalities, OpenAI chính thức)',
      ...
      formPrimaryRequired: 'Phải chọn nhà cung cấp chính khi định tuyến bật',
      formModelRequired: 'Nhà cung cấp, tên mô hình và kiểu API phải đi cùng nhau',
