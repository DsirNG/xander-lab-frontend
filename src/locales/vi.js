...
export default {
  ...
  blog: {
    ...
    saveDraftLocalFallback: 'Lưu máy chủ thất bại; bản nháp được giữ trên thiết bị này',
  ...
  blogPlans: {
    ...
    oneShot: 'Một lần',
    oneShotHint: 'Mỗi kế hoạch chỉ chạy đúng một lần vào thời gian đã lên lịch và tự động hoàn tất',
    statusFinished: 'Đã hoàn tất',
    ...
    deleteConfirm: 'Xóa kế hoạch "{{topic}}"? Hành động này không thể hoàn tác.',
    ...
    emptyHint: 'Bấm "Kế hoạch mới" ở góc trên bên phải để đặt chủ đề và thời gian',
    ...
    topicsHint: 'Mỗi ngày dùng một chủ đề theo thứ tự, hết vòng lại quay đầu',
  ...
  auth: {
    ...
    login: {
      ...
      sendCode: 'Gửi mã',
      autoRegisterHint: 'Người dùng mới sẽ được tự động đăng ký. Tiếp tục tức là bạn đồng ý với điều khoản.',
  ...
  profile: {
    ...
    blogManage: {
      title: 'Quản lý blog',
      description: 'Quản lý bài viết: chỉnh sửa, nháp, xuất bản và thùng rác',
      createNew: 'Bài viết mới',
      tabs: { all: 'Tất cả', published: 'Đã xuất bản', draft: 'Bản nháp', trash: 'Thùng rác' },
      ...
      confirmPermanentMessage: 'Xóa vĩnh viễn «{{title}}»? Thao tác này không thể hoàn tác.',
    ...
    mcp: {
      ...
      consentDescription: 'Client “{{client}}” yêu cầu các quyền sau. Client chỉ được truy cập nội dung thuộc tài khoản này.',
    ...
    emailReminders: {
      title: 'Email hẹn giờ',
      description: 'Thiết lập gửi email theo lịch, tự động hóa tiếp cận tin nhắn',
      ...
      messageHtmlPlaceholder: 'Có thể viết HTML, ví dụ <p>Xin chào</p><strong>in đậm</strong>',
      ...
      templatePickerHint: 'Chọn mẫu sẽ chèn HTML vào nội dung. Không chọn thì giữ văn bản thuần.',
      useThisTemplate: 'Dùng',
      clearToPlain: 'Đổi lại văn bản thuần',
      applyTemplateStarter: 'Chèn mẫu HTML',
      messageInputHint: 'Nhập tự do. Hỗ trợ HTML tùy chỉnh. Bấm «Chọn mẫu» để dùng bố cục.',
      plainContentHint: 'Nhập tự do. Hỗ trợ HTML tùy chỉnh.',
      htmlContentHint: 'Đang dùng bố cục «{{template}}»; nội dung gửi dạng HTML.',
      ...
      fieldsRequired: 'Vui lòng điền người nhận, thời gian, chủ đề và nội dung',
      ...
      confirmDeleteMessage: 'Xóa «{{name}}»? Thao tác này không thể hoàn tác.',
      cancelDelete: 'Hủy',
      tipTitle: 'Mẹo nhỏ',
      tipBody: 'Email hẹn giờ sẽ tự gửi khi đến giờ. Hãy kiểm tra người nhận và nội dung.',
  ...
  components: {
    ...
    share: {
      ...
      modals: {
        ...
        deleteScenarioLoseWarning: 'Mã demo của kịch bản này không thể khôi phục sau khi xóa.',
