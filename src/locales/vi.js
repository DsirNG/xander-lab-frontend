...
export default {
  ...
  profile: {
    ...
    subtitle: 'Quản lý tài khoản và lời nhắc tự động',
    open: 'Mở trung tâm cá nhân',
    account: 'Tài khoản đang đăng nhập',
    emailReminders: {
      title: 'Email hẹn giờ',
      taskList: 'Danh sách tác vụ email',
      ...
      emptyHint: 'Viết lời nhắn ở bên phải và chọn thời gian gửi.',
      addTitle: 'Thêm email hẹn giờ',
