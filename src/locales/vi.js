...
export default {
  ...
  profile: {
    ...
    emailReminders: {
      ...
      previewTitle: 'Xem trước email HTML',
      safePreview: 'Xem trước an toàn',
      previewSubject: 'Chủ đề email sẽ hiển thị tại đây',
      previewMessage: 'Lời nhắn sẽ được trình bày trong một email HTML rõ ràng.',
      htmlSafetyHint: 'Mẫu hệ thống sẽ dựng email. Nội dung nhập luôn được xử lý dưới dạng văn bản thuần, không chạy HTML hay tập lệnh.',
