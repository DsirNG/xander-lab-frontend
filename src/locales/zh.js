...
export default {
  ...
  profile: {
    ...
    account: '已登录账户',
    comingSoon: '功能即将上线',
    comingSoonHint: '该模块正在准备中，当前可先使用定时邮箱管理自动化提醒。',
    nav: {
      account: '账户信息',
      security: '安全设置',
      notifications: '通知设置',
    ...
    emailReminders: {
      ...
      plainContentHint: '纯文本会按所选模板排版发送；换行会保留。',
      htmlContentHint: 'HTML 将按所选模板渲染发送；脚本与危险标签会被过滤。',
      plainPreviewBadge: '纯文本',
      htmlPreviewBadge: 'HTML 渲染',
      htmlSafetyHint: '支持纯文本与 HTML；可选择多套模板渲染邮件。',
      create: '创建定时邮件',
      createAndSave: '创建并保存',
      creating: '正在创建…',
      created: '定时邮件已创建',
