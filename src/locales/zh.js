...
export default {
  ...
  blog: {
    ...
    editor: { toolbar: '写作工具', addBlock: '添加内容块', text: '文本', h1: 'H1', h2: 'H2', h3: 'H3', todo: '待办', list: '列表', orderedList: '有序列表', quote: '引用', code: '代码', insertContent: '插入内容', imageGif: '图片 / GIF', video: '视频（即将支持）', divider: '分割线', table: '表格', codeBlock: '代码块', quoteBlock: '引用块', bold: '加粗', italic: '斜体', strike: '删除线', addLink: '添加链接', linkPrompt: '输入链接地址，留空可移除链接', undo: '撤销', redo: '重做', clearFormatting: '清除格式', insertTable: '插入表格' },
    agent: {
