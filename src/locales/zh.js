...
export default {
    ...
    landing: {
        ...
        agentWindow: {
            welcome: "欢迎回来",
            subtitle: "你的 AI 智能伙伴，随时为你提供专业、可靠的帮助",
            placeholder: "告诉 Dinqor 你想做什么...",
            generateImage: "生成图片",
            searchWeb: "搜索网页",
        ...
        engines: {
            ...
            knowledge: {
                ...
                point3: "互动测验",
                point4: "掌握度追踪",
                reciteScoreTitle: "背诵片段打分",
                viewDetails: "查看详情",
                quote: "出师表节选：臣本布衣，躬耕于南阳...",
                scoreUnit: "分",
            },
            automation: {
                badge: "D",
                ...
                platformCommunity: "本站社区 MCP",
                platformCsdn: "CSDN MCP",
                platformJuejin: "掘金 MCP",
                platformMulti: "双发 / 多发 更多平台",
            },
        },
        knowledgeMirror: {
            ...
            stage2Badge: "02. AI 主动出题与互动答题卡",
            stage2Title: "对话出题与答题卡",
            stage2Desc: "沉浸式题卡，自适应交互答题",
            stage3Badge: "03. 实时判分与深度解析",
            stage3Title: "智能判分与证据链",
            stage3Desc: "秒级评分、错点溯源与原文比对",
            stage4Badge: "04. 薄弱点智能巩固与复习",
            stage4Title: "薄弱点下钻与排程",
            stage4Desc: "靶向加练，艾宾浩斯曲线闭环",
            ...
            stat2: "判分响应",
            stat3: "记忆留存率",
            ctaButton: "立即打开个人知识镜像与私教",
            simTitle: "AI 私教交互式测评终端 (Live Quiz Card Simulator)",
            voiceActive: "语音背诵模式中",
            switchVoice: "切换语音背诵",
            scoreUnit: "分",
        },
        dinqorAgent: {
            ...
            tabMemory: "长程记忆召回",
            ctaButton: "进入 DinQor Agent 大脑工作台",
        },
        headlessAutomation: {
        ...
        ecosystem: {
            title: "附属生态与创作者社区",
            subtitle: "连接生态、展示灵感、共建未来",
            gallery: {
                title: "3D 资产互动展厅",
                desc: "在线浏览、交互体验、一键应用至创作",
                action: "探索展厅",
            },
            flowcraft: {
                title: "FlowCraft 组件实验工坊",
                desc: "可视化组件编排与智能联动，快速构建你的专属流程",
                action: "进入工坊",
            },
            community: {
                title: "创作者大厅与技术动态",
                desc: "分享灵感、发现项目、掌握最新动态",
                action: "进入社区",
            },
        },
        techFoundation: {
            tag: "为什么选择我们",
            title: "工业级技术底座与安全背书",
            subtitle: "构建安全、稳定、可扩展的 AI 创作与 3D 生产力平台",
            sandbox: {
                num: "01",
                title: "ChatGPT 级沙箱隔离",
                desc: "独立运行时 + 网络与文件隔离，确保你的数据与执行环境绝对安全可控。",
                pill1: "进程隔离",
                pill2: "网闸隔离",
                pill3: "数据隔离",
            },
            gateway: {
                num: "02",
                title: "动态多模型网关",
                desc: "智能路由与负载均衡，按需调用最优模型，稳定高效、成本可控。",
                pill1: "多模型接入",
                pill2: "智能路由",
                pill3: "弹性伸缩",
            },
            ledger: {
                num: "03",
                title: "确定性计费账本",
                desc: "精确计量每一次调用，链上可审计，透明可追溯，费用清晰可控。",
                pill1: "精确计量",
                pill2: "链上存证",
                pill3: "可审计",
            },
            collaboration: {
                num: "04",
                title: "全端协同 (Taro 4 + WebSocket)",
                desc: "一次开发，多端实时协同，连接你的创意与团队，随时随地高效创作。",
                pill1: "多端一致",
                pill2: "实时通信",
                pill3: "高可用",
            },
        ...
        roadmap: {
            tag: "Roadmap",
            title: "与技术，共同进化",
            subtitle: "从生成到交互，从工具到世界，持续拓展 AI 与 3D 的边界",
            phase1: {
                phase: "阶段 01",
                title: "Code-Only 3D",
                desc: "通过代码生成与编辑 3D 资源，快速、可控、可复现。",
                status: "当前阶段",
            },
            phase2: {
                phase: "阶段 02",
                title: "Bridge to Unity / Unreal / Blender",
                desc: "打通主流 3D 引擎与 DCC 工具链，无缝导入、实时预览。",
                status: "即将上线",
            },
            phase3: {
                phase: "阶段 03",
                title: "角色表情 / Blendshape",
                desc: "AI 驱动角色表情生成与 Blendshape，让角色更生动、更真实。",
                status: "规划中",
            },
            phase4: {
                phase: "阶段 04",
                title: "AI 3D 开放世界",
                desc: "生成可交互的 3D 开放世界，从内容到玩法，AI 原生智能驱动。",
                status: "长期愿景",
            },
        },
        ctaBanner: {
        ...
        footer: {
            ...
            commTitle: "社区",
            commHall: "创作者大厅",
            commDiscord: "Discord 社区",
            commInspiration: "探索灵感",
            aboutTitle: "关于我们",
            aboutCompany: "公司介绍",
            aboutJoin: "加入我们",
            aboutContact: "联系我们",
    ...
    blog: {
        ...
        summaryHint:
            "最多 100 字：外部平台按最严格上限执行（掘金要求 50-100 字）",
        ...
        media: {
            insertImage: "插入图片",
            dropImage: "拖放或选择图片 / GIF，上传后插入到光标位置",
            uploadingImage: "正在上传",
            imageInserted: "图片已插入正文",
            imageUploadFailed: "图片上传失败，请重试",
            invalidImage: "请选择图片或 GIF 文件",
            imageTooLarge: "图片大小不能超过 10MB",
            altText: "图片说明（可访问性）",
            addToArticle: "插入正文",
            libraryTitle: "插入图片",
            uploadImage: "上传图片",
            uploadSuccess: "图片已上传到素材库",
            searchPlaceholder: "搜索图片名称",
            scopes: { recent: "最近上传", mine: "我的图片", gif: "GIF" },
            emptyTitle: "还没有可用图片",
            emptyHint: "上传一张图片后会保存在你的素材库中",
            selectHint: "选择一张图片查看详情",
            selectedCount: "已选择 {{count}} 张图片",
            cancel: "取消",
            insertAtCursor: "插入到当前位置",
        },
        editor: {
            toolbar: "写作工具",
            addBlock: "添加内容块",
        ...
        agent: {
            title: "博客生成助手",
            back: "返回博客",
            headline: "把想法变成可发布的知识博客",
            description:
                "输入一个主题或一篇日记。博客生成助手会联网调研、写作并审校，给出带来源的完整文章。",
            inputLabel: "主题或日记",
            inputPlaceholder:
                "例如：最近我开始用 AI 写代码，效率更高了，但我担心自己理解代码的能力在下降……",
            inputType: "输入类型",
            audience: "目标读者",
            tone: "写作语气",
            defaultAudience: "对这个主题感兴趣的读者",
            defaultTone: "清晰、真诚、可操作",
            generate: "调研并写作",
            running: "正在调研和写作…",
            waiting: "等待你的输入",
            ready: "等待审阅",
            failed: "博客生成助手未能完成这次任务",
            complete: "文章已生成，可开始审阅",
            workflow: "博客生成助手工作流",
            guardrail:
                "个人经历始终标注为作者经历；外部事实必须可追溯，系统绝不会自动公开发布。",
            stages: {
                analyze: "确定文章角度",
                research: "调研与核验",
                write: "撰写完整文章",
            ...
            stageDescriptions: {
                analyze: "识别读者、观点和需要补充的证据。",
                research: "联网核验文章中的外部事实。",
                write: "生成完整的 Markdown 知识博客。",
                illustrate: "按需生成插图并保存到你的素材库。",
                review: "检查证据、表达和发布状态。",
            },
            article: "生成的文章",
            toDraft: "进入编辑器",
            draftCreated: "已创建草稿，现在可以编辑并发布。",
            sources: "调研来源",
            noSources: "这篇文章未保留外部来源。",
            review: "编辑审校",
            reviewPending: "博客生成助手完成后会显示审校结果。",
            inputRequired: "请先输入主题或日记。",
            contentFocus: "内容边界",
            mustCover: "文章主干",
            relatedExpansion: "直接扩展",
            outOfScope: "不主动扩展",
            knowledgeGraph: "知识关系图谱",
            illustrations: "知识插图",
            illustrationStatuses: {
                running: "正在生成并保存插图。",
                complete: "插图已生成并插入文章，同时保存到你的素材库。",
                partial: "部分插图已生成，其余插图可以稍后补充。",
                failed: "插图生成失败，文章内容仍可正常审阅。",
                disabled: "尚未配置图片模型，本次已跳过插图。",
                none: "博客生成助手判断这篇文章不需要额外插图。",
            },
            processing: "处理中 {{duration}}",
            processed: "已处理 {{duration}}",
            processedDone: "已处理",
            processFailed: "处理失败",
            openPreview: "点击预览文章",
            previewEmpty: "选择生成的博客以预览",
            untitled: "未命名文章",
            newTask: "新任务",
            newConversation: "新建会话",
            conversations: "会话列表",
            noConversations: "还没有历史会话",
            restoring: "正在恢复博客生成任务…",
            multiTurnHint:
                "继续输入修改要求，博客生成助手会基于当前文章生成新版本。",
            revise: "继续修改",
            revisionComplete: "文章已按本轮要求更新",
            waitingForStage: "正在准备下一阶段…",
            inputLockedPlaceholder: "博客生成助手处理中，请稍候",
            confirmPublish: "确认发布",
            viewArticle: "查看文章",
            showMeta: "显示调研与审校信息",
            hideMeta: "收起调研与审校信息",
        ...
        agentChat: {
            ...
            description:
                "我可以帮你写博客、查资料或处理其他任务。试试：「帮我写一篇关于 X 的博客」。",
            inputPlaceholder: "告诉 Dindor 你想做什么…",
            addAttachment: "添加附件",
            uploadImagesFiles: "添加图片和文件",
            uploadFromDevice: "从电脑上传",
            file: "文件",
            removeAttachment: "移除附件",
            attachmentLimit: "每次最多上传 5 个附件。",
            attachmentTooLarge: "“{{name}}”超过 20MB。",
            attachmentUploadFailed: "部分附件上传失败，请重试。",
            ...
            planDropped: "已放弃",
            reflectionTitle: "自检",
            reflectionRound: "自检 · 第 {{round}} 轮",
            inputRequired: "请先输入你想让智能体做什么。",
            sendFailed: "消息发送失败。",
            loadFailed: "对话加载失败。",
            restoring: "正在恢复对话…",
            ...
            traceShow: "展开详情",
            traceHide: "收起详情",
            selfCheckSummary: "智能体正在继续完善这一轮的结果",
            deepThinking: "深度思考",
            deepThinkingHint:
                "开启后智能体会自检并补完计划里的步骤，结果更完整，但回复更慢",
            viewBlog: "查看博客",
            generatingImage: "正在生成图片…",
            imageToolTitle: "AI 图片生成",
            imageToolHint:
                "根据你的描述生成独立配图/封面图，完成后自动保存到素材库",
            newChat: "新聊天",
            recentSessions: "最近",
            tierFree: "免费版",
            quickGenerateImage: "生成图片",
            quickWrite: "撰写或编辑",
            quickWritePrompt: "撰写或编辑文章",
            quickSearch: "搜索网页",
            share: "分享",
            shareDialog: "分享对话",
            shareLinkTitle: "分享对话链接",
            shareLinkHint: "复制链接后，对方无需登录即可查看此对话",
            shareGenerating: "生成中...",
            copied: "已复制",
            copyShareLink: "复制分享链接",
            startHeadline: "我们先从哪里开始呢？",
            generateImagePrompt: "生成一张图片: {{query}}",
            searchPlaceholder: "搜索会话...",
            recentChats: "最近聊天",
            searchNoMatches: "没有找到匹配的会话",
            noSessions: "暂无会话记录",
            user: "用户",
            expandSidebar: "展开会话列表",
            quizTitle: "练习题",
            quizProgress: "第 {{current}} / {{total}} 题",
            quizAnswered: "已完成 {{count}} / {{total}}",
            quizPrevious: "上一题",
            quizNext: "下一题",
            quizSubmit: "提交全部答案",
            quizSubmitted: "答案已提交，等待批改",
            quizAnswerPlaceholder: "输入你的答案…",
            quizUnanswered: "还有 {{count}} 题未作答",
            artifactTitle: "代码交付",
            artifactFileCount: "{{count}} 个文件",
            artifactFiles: "文件列表",
            artifactEntry: "入口",
            artifactDownload: "下载",
            artifactDownloadFile: "下载 {{name}}",
            artifactRunHint: "运行方式",
            artifactPreviewHint: "可直接预览",
            artifactTruncated: "该文件过长，卡片里只展示了前一部分",
        },
        agentImages: {
            title: "图片",
            inputPlaceholder: "描述新图片",
            think: "思考",
            generated: "生成图片",
            mine: "我的图片",
            ...
            retry: "重新加载",
            emptyTitle: "还没有生成的图片",
            emptyHint: "在输入框描述一张图片，智能体会生成并自动保存到这里",
            loadMore: "加载更多",
            loadingMore: "加载中…",
        },
        agentMcp: {
        ...
        agentSkills: {
            ...
            archive: "归档",
            archiveTitle: "归档技能",
            archiveConfirm: "归档「{{name}}」？模型之后不会再读到这一条。",
            archiveFailed: "归档失败，请稍后重试",
            archived: "已归档",
            createTitle: "新建技能",
            newVersionTitle: "为 {{key}} 新建版本",
            nonExecutableHint:
                "技能只是做法说明：它不会给智能体增加新工具或新数据源，也不会绕过审批策略。",
            fieldKey: "技能标识",
            fieldKeyHint: "小写字母开头，可含数字和连字符，创建后不可修改",
            fieldName: "名称",
            ...
            formDescriptionTooLong: "适用场景最多 {{max}} 个字符",
            formInstructionsRequired: "请填写做法说明",
            formInstructionsTooLong: "做法说明最多 {{max}} 个字符",
    ...
    blogPlans: {
        ...
        customDailyHint:
            "每天同一时刻自动生成并发布一篇，AI 会保证每天的文章内容不重复",
        knowledgeBase: "绑定知识库",
        noKnowledgeBase: "不绑定知识库",
        autoPublish: "内容生成后自动发布到已选平台",
        overview: "计划概览",
        totalPlans: "计划总数",
        activePlans: "待执行",
        pausedPlans: "已暂停",
        completedPlans: "已完成",
        publishRhythm: "发布节奏",
        localDailyPublish: "本站每日发布数量",
        postsPerDay: "篇/天",
        upcomingToday: "今日即将执行",
        noUpcomingToday: "今天没有待执行计划",
        scheduleType: "计划类型",
        typeOnce: "一次性",
        typeOnceHint: "仅在指定日期执行一次",
        typeDaily: "每日",
        typeDailyHint: "每天同一时间执行",
        typeWeekly: "每周",
        typeWeeklyHint: "每周同一天执行",
        executionDate: "执行日期",
        firstExecutionDate: "首次执行日期",
        publishPlatforms: "发布平台",
        aiDirection: "AI 规划选项",
        aiDeep: "深度解析",
        aiDeepHint: "深入拆解原理与最佳实践",
        aiPractical: "实战教程",
        aiPracticalHint: "步骤清晰，注重操作演示",
        aiNews: "资讯解读",
        aiNewsHint: "提炼热点与关键信息",
        aiOpinion: "观点评论",
        aiOpinionHint: "表达观点并给出论据",
        localPlatform: "本站（默认）",
        aiGenerate: "AI 生成计划",
        aiGenerateTitle: "AI 生成多日计划",
        aiGenerateDesc:
            "输入主题方向，AI 将按天拆分主题，从明天起每天同一时刻自动生成并发布一篇",
        aiSeed: "主题方向",
    ...
    notifications: {
        ...
        markedAll: "已全部标记为已读",
        viewPlans: "查看定时发文计划",
        testBroadcast: "测试 SSE 广播",
        broadcasting: "广播中…",
        broadcastSent: "SSE 测试广播已发送（{{count}} 条连接）",
    ...
    workspace: {
        ...
        home: {
            ...
            actions: {
                chat: {
                    title: "智能体对话",
                    description: "与你的知识镜像对话",
                },
                import: { title: "导入知识", description: "导入文档或链接" },
                practice: {
                    title: "生成练习",
                    description: "根据知识生成练习题",
                },
            ...
            sections: {
                ...
                conversations: {
                    title: "最近对话",
                    items: {
                        architecture: "中级前端开发知识体系梳理",
                        fileSystem: "下载链路设计：File System Access API",
                        websocket: "WebSocket 和 SSE 的区别与应用",
                    },
                },
                knowledge: {
                    title: "最近知识库",
                    items: {
                        ...
                        javascript: "JavaScript 核心知识图谱",
                        productDesign: "AI 产品设计方法论",
                    },
                },
                plans: {
                    title: "最近计划",
            ...
            todos: {
                title: "待办与提醒",
                items: {
                    closure: "复习《JS 作用域与闭包》",
                    notes: "完成前端工程化笔记整理",
                    websocket: "发布《WebSocket 最佳实践》",
                    dailyStudy: "每日学习打卡",
                    knowledgeUpdate: "更新知识库：AI 产品方法论",
                },
            },
            suggestions: {
                title: "AI 建议",
                ...
                items: {
                    review: {
                        title: "复习间隔提醒",
                        description:
                            "根据遗忘曲线，你有 6 个知识点即将遗忘，建议今日复习。",
                        action: "去复习",
                    },
                    path: {
                        title: "学习路径推荐",
                        description:
                            "为你推荐「前端性能优化」学习路径，已匹配你的知识图谱。",
                        action: "查看路径",
                    },
                    inspiration: {
                        title: "博客灵感",
                        description:
                            "你最近研究了 WebSocket，可考虑写一篇对比长轮询的文章。",
                        action: "去创作",
                    },
                },
            },
            meta: {
                yesterday: "昨天",
                todayTime: "今天 20:00",
                tomorrowTime: "明天 10:00",
                completed: "已完成",
            },
        },
        subtitle:
            "集中管理你的自动化与创作工具：定时发文、图生3d、工作室、博客管理与定时邮箱。",
        settings: "个人设置",
        backHome: "返回首页",
        points: "积分",
        userMenu: "用户菜单",
    ...
    profile: {
        ...
        mcp: {
            title: "MCP 授权",
            description:
                "授权 MCP 客户端，支持对博客内容进行创建、读取、更新和发布。",
            checking: "正在检查授权...",
            authorized: "已授权",
            ...
            consentDescription:
                "客户端「{{client}}」请求访问以下能力。确认后，它将只能操作当前账号拥有的内容。",
            consentApprove: "批准授权",
            consentDeny: "拒绝",
            consentLoadFailed: "无法加载 MCP 授权请求",
            consentFailed: "MCP 授权操作失败",
            consentScopeHint:
                "已默认勾选上次授权的范围，可取消勾选某项以缩小授权范围。",
        ...
        csdn: {
            ...
            qrAlt: "CSDN 登录二维码",
            scanHint:
                "使用 CSDN App 或微信扫码授权。二维码将会在短时间内失效。",
            waiting: "等待授权中",
        ...
        emailReminders: {
            ...
            messageHtmlPlaceholder:
                "可直接编写 HTML，例如 <p>你好</p><strong>加粗</strong>",
            previewTitle: "邮件效果预览",
            safePreview: "预览",
            ...
            templatePickerHint:
                "选中后插入 HTML 样例并套用版式；也可跳过，直接自定义 HTML。",
            useThisTemplate: "使用",
            clearToPlain: "改回纯文本",
            applyTemplateStarter: "填入 HTML 示例",
            messageInputHint:
                "默认可直接输入；支持自定义 HTML 邮件。需要版式时点「选择模板」。",
        ...
        anchored: {
            ...
            phases: {
                theory: {
                    ...
                    points: [
                        "主轴与交叉轴定义",
                        "Placement 语义化 (top/start/...)",
                        "Absolute vs Fixed 的抉择",
                    ],
                },
                hook: {
                ...
                container: {
                    ...
                    points: [
                        "Flip / Shift / Padding 生存策略",
                        "Focus Trap 与 Backdrop 管理",
                        "ARIA 职责边界界定",
                    ],
                },
            },
    ...
    components: {
        ...
        toast: {
            ...
            guide: {
                ...
                title: "Toast // 源码实现",
                subtitle:
                    "“专为现代 C 端体验设计的高级物理基准通知系统。精准的时间控制与硬件加速的流体动画完美融合。”",
                architecture: {
                    engine: "实验性引擎",
                    physics: "动力学与运动学",
                    logic: "核心逻辑概览",
                    logicDesc:
                        "解耦的状态管理确保通知在页面导航中持久存在，同时保持像素级的定时精度。",
                },
                sections: {
                    physics: {
                        title: "01. 物理项逻辑",
        ...
        guide: {
            ...
            loadFailed: "无法加载组件源码。",
            defaultDesc:
                "该组件通过动态沙箱引擎实现，包含了完整的组件逻辑层与环境包裹层。",
        },
        share: {
            header: {
                title: "组件工作室",
            ...
            modals: {
                ...
                oneClickLoad: "一键装载",
                helpIntro:
                    "这是一项开发向导功能。点击下方按钮后，我们将为您本环节自动填入",
                helpMeta:
                    "该操作将会为您填入 Toast 组件的完整基本信息（中英文名称、描述及版本），跳过繁杂的手动录入。",
                helpScenario:
                    "该操作将会一键填充一份同时包含了 { 成功态 / 失败态 / 进度流 } 等交互机制的完整 React DOM 运行场景。",
                helpLogic:
                    "该操作将会为您直接写入 ToastContext、ToastItem 和 ToastContainer 三个具备相互依赖关系的核心架构文件。",
                helpEnv:
                    "该操作将会为您填入 <ToastProvider /> 等全量外层上下文节点，使您的演示代码能够正常接管全局路由或顶层依赖。",
                helpCss:
                    "该操作将会为您补充 Toast 高性能进退场的 CSS Keyframes 等基底渲染数据。",
                ...
                startTour: "启动教学向导",
                welcomeDesc:
                    '侦测到系统架构池处于初始完全清空状态，且您是第一次进入 DinQorAI Workspace。为了帮助您最快熟悉这个"四合一"热重载沙盒，我们为您内置了一整套全局通知系统（Toast）的骨架。是否愿意花 30 秒的世界时间，跟随强光指引，一点点体验如何无脑将组件拼装、编译并最终发射运作？',
    ...
    knowledge: {
        ...
        retry: "重新加载",
        staleDataWarning: "刷新失败，当前显示的是上一次成功加载的数据。",
        attemptPollError:
            "暂时无法刷新录音任务，系统会有限重试；任务不会丢失。",
        retryAttempt: "立即重试",
        title: "个人知识镜像",
        subtitle: "持续记录你需要掌握的知识、测试证据与复习节奏。",
        add: "添加知识",
        loading: "正在加载知识镜像…",
        created: "知识已加入个人镜像",
        createTitle: "添加需要掌握的知识",
        create: "加入知识库",
        empty: "从第一个知识点开始",
        emptyHint: "添加原文或知识点，系统会持续记录你的掌握程度。",
        library: "我的知识",
        mastery: "掌握度",
        original: "知识原文",
        originalHidden: "原文已隐藏，请根据记忆完成背诵。",
        reviewCount: "已测试 {{count}} 次",
        audioTest: "录音背诵测试",
        audioHint: "隐藏原文后开始背诵，AI 将转写录音并检查与原文的差异。",
        start: "开始录音",
        stop: "结束并检查",
        recording: "正在录音…",
        microphoneUnavailable:
            "当前环境无法使用麦克风，请使用 HTTPS 或检查浏览器设置。",
        permissionTitle: "允许使用麦克风",
        permissionHint:
            "为了完成背诵测试，需要临时使用麦克风录制你的声音。点击允许后，浏览器会显示系统授权提示。",
        permissionBlockedHint:
            "麦克风权限此前已被拒绝。请点击地址栏左侧的权限图标允许麦克风，然后再次尝试授权。",
        permissionPrivacy:
            "录音仅用于本次转写和掌握度检查，不会在后台静默录制。",
        allowMicrophone: "同意并授权",
        agentTest: "智能体测验",
        agentTestHint:
            "让智能体按这条知识出题，你作答后由它逐题判分并更新掌握度。",
        askAgentToQuiz: "让智能体考我",
        quizPrompt:
            "考考我《{{title}}》（知识 ID：{{materialId}}）这条知识。直接用这个 ID 调用 quiz_knowledge，出几道题，我答完你再逐题判分。",
        noQuizYet:
            "还没有测验记录。测过一次之后，这里会显示得分和每道题的判分。",
        quizAt: "测验时间",
        yourAnswer: "你的回答",
        creditFull: "答对",
        creditPartial: "答对一半",
        ...
        wrong: "错误",
        transcript: "录音转写",
        nextReview: "建议下次复习：{{time}}",
        edit: "编辑",
        editTitle: "修改这条知识",
        save: "保存修改",
        updated: "修改已保存",
        editResetHint:
            "改动正文或知识类型会把掌握度清零并重新安排复习；只调标点或空白不受影响。",
        archive: "归档",
        restore: "恢复",
        archived: "已归档，不再出现在日常列表和到期复习中",
        restored: "已恢复到知识库",
        archivedNotice:
            "这条知识已归档：不参与到期复习，智能体也不会再拿它考你。",
        archivedEmpty: "没有归档的知识",
        archivedEmptyHint: "归档的知识会留在这里，随时可以恢复。",
        delete: "删除",
        deleteTitle: "删除这条知识？",
        deleteConfirm: "确认删除",
        deleteWarning:
            "「{{title}}」以及它的录音记录和测验留档会一并删除，不可恢复。",
        deleteArchiveHint: "只是暂时不想学？改用归档，内容会完整保留。",
        view: { ACTIVE: "在用", ARCHIVED: "已归档" },
        stats: {
            total: "知识总数",
            learning: "正在掌握",
            mastered: "稳定掌握",
        ...
        form: {
            ...
            content: "原文或知识内容",
            contentHint:
                "首版支持直接粘贴文字；图片 OCR 与文档自动拆分将在后续接入。",
        },
    ...
    knowledgeBase: {
        ...
        files: {
            ...
            viewGrid: "网格视图",
            viewList: "列表视图",
            emptyTitle: "当前分类下暂无文档",
            emptyFolderOnly: "当前目录下暂无直接文件",
            emptyHint: "点击右上角上传文档，系统将自动拆解章节并构建思维导图。",
            uploadNow: "立即上传文档",
            name: "名称",
            status: "知识结构状态",
            size: "大小",
        ...
        viewer: {
            ...
            tabInfo: "文件属性与标签",
            regenerate: "重新生成结构图",
            regenerateSuccess: "已重新生成结构导图",
            chapterGenSuccess: "已生成本章结构图",
            reidentifySuccess: "重新识别完成",
            reidentifyBtn: "重新解析章节与正文",
            rawFile: "源文件",
            loadFailed: "加载预览失败",
        ...
        tags: {
            ...
            createTitle: "新建标签词条",
            nameLabel: "标签名",
            namePlaceholder: "例如：技术架构、产品设计",
            colorLabel: "标签颜色",
            descLabel: "说明（可选）",
            descPlaceholder: "便于回忆标签用途",
            typeAndEnter: "输入标签后回车",
            attached: "标签已添加",
            detached: "标签已移除",
            created: "标签创建成功",
        },
    ...
    home: {
        ...
        hero: {
            ...
            outline: "分享与自动化",
            description:
                "分享前端 Demo，定时生成并发布博客，也让日常提醒准时发生。",
            explore: "探索工具",
            studio: "打开 Studio",
        },
        tools: {
            agent: {
                ...
                title: "定时博客 Agent",
                description:
                    "设置主题与执行时间，Agent 将自动生成文章，并同步发布至已连接的平台。",
                action: "了解博客 Agent",
            },
            email: {
                label: "邮件任务",
            ...
            demo: {
                ...
                title: "分享组件 Demo",
                description:
                    "为可复用的前端组件提供源码、在线预览和可直接发送的一键分享链接。",
                action: "浏览组件 Demo",
            },
        },
        previews: {
            agent: {
                ...
                topicValue: "构建可访问的组件",
                schedule: "执行时间",
                scheduleValue: "每周一 · 09:00",
                article: "文章",
                generating: "生成中",
                nextRun: "● 下次执行：2026 年 5 月 26 日",
                synced: "已同步",
            },
            email: {
                to: "收件人",
                subscribers: "订阅者",
                cc: "抄送",
                subject: "DinQorAI 每周更新",
                greeting: "你好，",
                body: "这是本周的最新内容。",
                signature: "DinQorAI 团队",
                schedule: "每周五",
            },
            demo: {
                preview: "预览",
    ...
    seo: {
        home: {
            title: "AI 智能体平台",
            description:
                "DinQorAI 智能体平台提供智能对话、内容创作、图片生成、文档分析、知识管理和任务自动化能力。",
        },
        infra: {
            title: "UI 基础设施系统",
            description:
                "了解 DinQorAI 如何构建可复用的 UI 基础设施、定位系统与健壮的前端架构。",
        },
        modules: {
            title: "交互式前端模块",
        ...
        components: {
            title: "React 组件展示",
            description:
                "浏览 DinQorAI 的可复用 React 组件、实现指南与交互式 UI 示例。",
        },
        default: {
            title: "前端工程资源",
    ...
    admin: {
        ...
        users: {
            title: "用户管理",
            subtitle: "查询与封禁/解封用户；封禁后该用户全部登录会话立即失效",
            keywordPlaceholder: "搜索用户名 / 昵称 / 邮箱",
            username: "用户名",
            email: "邮箱",
            role: "角色",
            roleAdmin: "管理员",
            ...
            banTitle: "封禁用户",
            banMessage:
                "确定封禁 {{name}} 吗？封禁后其全部登录会话将立即失效。",
            unbanTitle: "解封用户",
            unbanMessage: "确定解封 {{name}} 吗？",
            banned: "已封禁该用户",
            unbanned: "已解封该用户",
            empty: "暂无用户",
            emptyHint: "换个关键字或翻页再试试",
            loadFailed: "用户列表加载失败",
        },
        providers: {
            title: "模型供应商",
            subtitle: "集中管理模型接口；API 密钥加密存储，只进不出",
            add: "新增供应商",
            createTitle: "新增模型供应商",
            editTitle: "编辑模型供应商",
            create: "创建",
            ...
            baseUrl: "接口地址",
            apiKey: "API 密钥",
            apiKeyHint: "密钥加密后存储，页面与接口均不回显",
            apiKeyPlaceholder: "sk-...",
            apiKeyEditPlaceholder: "留空表示保持原密钥不变",
            description: "备注",
            enabled: "启用",
            status: "状态",
            statusEnabled: "已启用",
            ...
            deleteTitle: "删除供应商",
            deleteMessage:
                "确定删除 {{name}} 吗？仍被功能配置引用的供应商无法删除。",
            nameTaken: "已存在同名供应商",
            formRequired: "名称与接口地址为必填项",
            formKeyRequired: "创建时必须填写 API 密钥",
            saveFailed: "供应商保存失败",
        ...
        pricing: {
            title: "模型定价",
            subtitle:
                "维护各模型的 token 计费单价；未配置的模型回退服务端默认价。",
            add: "新增定价",
            createTitle: "新增模型定价",
            editTitle: "编辑模型定价",
            model: "模型名称",
            modelPlaceholder: "如 gpt-5.6-terra",
            modelHint: "模型名称创建后不可修改",
            priceUnit: "单价单位：元 / 1M tokens",
            inputPrice: "输入单价",
            outputPrice: "输出单价",
            cachedReadPrice: "缓存读取",
            cachedWritePrice: "缓存写入",
            remark: "备注",
            remarkPlaceholder: "价目来源、生效说明等",
            enabled: "参与计费（停用后回退服务端默认价）",
            status: "状态",
            statusEnabled: "已启用",
            statusDisabled: "已停用",
            actions: "操作",
            ...
            created: "定价已保存",
            updated: "定价已更新",
            deleted: "已删除，该模型计费回退默认价",
            deleteTitle: "删除模型定价",
            deleteMessage:
                "确定删除 {{name}} 的定价吗？删除后该模型计费回退服务端默认价。",
            formRequired: "模型名称与输入/输出单价为必填项",
            invalidPrice: "单价必须是不小于 0 的数字",
            saveFailed: "定价保存失败",
            loadFailed: "定价列表加载失败",
            empty: "暂无自定义定价",
            emptyHint: "新增后按模型精确匹配计费；未配置的模型使用服务端默认价",
        },
        wechatCredential: {
            title: "微信登录凭据",
            subtitle:
                "维护微信小程序登录用的 AppID / AppSecret。密钥加密落库，保存后不再回显。",
            appId: "AppID",
        ...
        configs: {
            ...
            actions: "操作",
            edit: "配置",
            formEnabled: "启用管理台模型路由",
            formEnabledHint: "关闭后该功能继续使用环境变量配置",
            primaryProvider: "主模型供应商",
            primaryModel: "主模型名称",
            primaryApiStyle: "主模型接口风格",
            fallbackProvider: "兜底供应商",
            fallbackModel: "兜底模型名称",
            fallbackApiStyle: "兜底模型接口风格",
            apiStyleImages: "图片接口 /images/generations",
            apiStyleChat:
                "对话接口 /chat/completions（messages+modalities，OpenAI 官方）",
            apiStyleChatPrompt:
                "对话接口 /chat/completions（prompt 参数，聚合网关如 okinto）",
            apiStyleResponses: "Responses 接口 /responses",
            apiStyleDashscopeAsr:
                "DashScope 录音转写 /services/audio/asr/transcription",
            apiStyleHint:
                "同型号模型在不同供应商可能走不同接口形态：OpenAI 官方图片用 messages+modalities，okinto 等聚合网关用顶层 prompt 参数，旧接口用 /images/generations",
            configHint:
                "每个槽位 = 一家供应商 + 模型名 + 接口风格。只用一个模型时填主模型即可，兜底留空；兜底只在主模型调用失败时启用，应配置其他供应商或备选模型，与主模型相同则无意义。",
            formFallbackDuplicate:
                "兜底模型与主模型相同（同供应商+同模型），请配置其他供应商或模型",
            selectProvider: "选择供应商",
            noFallback: "无兜底",
            formUntypedWhileEnabled: "未启用时不能填写供应商、模型或接口风格",
            formPrimaryRequired: "启用后必须选择主模型供应商",
            formModelRequired: "供应商、模型名称与接口风格需同时填写",
            updated: "配置已保存",
            saveFailed: "配置保存失败",
            loadFailed: "配置加载失败",
            empty: "暂无配置",
