...
export default {
  ...
  workspace: {
    ...
    home: {
      ...
      actions: {
        chat: { title: '智能体对话', description: '与你的知识镜像对话' },
      ...
      overviewTitle: '今日概览',
      stats: { knowledge: '知识点总数', reviews: '待复习', studyTime: '今日学习时长', hours: '小时', articles: '已发布文章', articlesUnit: '篇', compared: '较昨日' },
      todos: { title: '待办与提醒', items: { closure: '复习《JS 作用域与闭包》', notes: '完成前端工程化笔记整理', websocket: '发布《WebSocket 最佳实践》', dailyStudy: '每日学习打卡', knowledgeUpdate: '更新知识库：AI 产品方法论' } },
      suggestions: {
        title: 'AI 建议',
        refresh: '换一换',
        items: {
          review: { title: '复习间隔提醒', description: '根据遗忘曲线，你有 6 个知识点即将遗忘，建议今日复习。', action: '去复习' },
          path: { title: '学习路径推荐', description: '为你推荐「前端性能优化」学习路径，已匹配你的知识图谱。', action: '查看路径' },
          inspiration: { title: '博客灵感', description: '你最近研究了 WebSocket，可考虑写一篇对比长轮询的文章。', action: '去创作' },
        },
      },
      meta: { yesterday: '昨天', todayTime: '今天 20:00', tomorrowTime: '明天 10:00', completed: '已完成' },
    },
  ...
  knowledge: {
    loadErrorTitle: '知识库加载失败', loadErrorHint: '暂时无法读取你的知识，请检查网络后重试。', retry: '重新加载', staleDataWarning: '刷新失败，当前显示的是上一次成功加载的数据。', attemptPollError: '暂时无法刷新录音任务，系统会有限重试；任务不会丢失。', retryAttempt: '立即重试',
    title: '个人知识镜像', subtitle: '持续记录你需要掌握的知识、测试证据与复习节奏。', add: '添加知识', loading: '正在加载知识镜像…', created: '知识已加入个人镜像', createTitle: '添加需要掌握的知识', create: '加入知识库', empty: '从第一个知识点开始', emptyHint: '添加原文或知识点，系统会持续记录你的掌握程度。', library: '我的知识', mastery: '掌握度', original: '知识原文', originalHidden: '原文已隐藏，请根据记忆完成背诵。', reviewCount: '已测试 {{count}} 次', audioTest: '录音背诵测试', audioHint: '隐藏原文后开始背诵，AI 将转写录音并检查与原文的差异。', start: '开始录音', stop: '结束并检查', recording: '正在录音…', microphoneUnavailable: '当前环境无法使用麦克风，请使用 HTTPS 或检查浏览器设置。', permissionTitle: '允许使用麦克风', permissionHint: '为了完成背诵测试，需要临时使用麦克风录制你的声音。点击允许后，浏览器会显示系统授权提示。', permissionBlockedHint: '麦克风权限此前已被拒绝。请点击地址栏左侧的权限图标允许麦克风，然后再次尝试授权。', permissionPrivacy: '录音仅用于本次转写和掌握度检查，不会在后台静默录制。', allowMicrophone: '同意并授权', agentTest: '智能体测验', agentTestHint: '让智能体按这条知识出题，你作答后由它逐题判分并更新掌握度。', askAgentToQuiz: '让智能体考我', quizPrompt: '考考我《{{title}}》（知识 ID：{{materialId}}）这条知识。直接用这个 ID 调用 quiz_knowledge，出几道题，我答完你再逐题判分。', noQuizYet: '还没有测验记录。测过一次之后，这里会显示得分和每道题的判分。', quizAt: '测验时间', yourAnswer: '你的回答', creditFull: '答对', creditPartial: '答对一半', creditNone: '答错', latestResult: '最近一次测试', score: '准确度', correct: '正确', missing: '遗漏', wrong: '错误', transcript: '录音转写', nextReview: '建议下次复习：{{time}}',
    edit: '编辑', editTitle: '修改这条知识', save: '保存修改', updated: '修改已保存', editResetHint: '改动正文或知识类型会把掌握度清零并重新安排复习；只调标点或空白不受影响。', archive: '归档', restore: '恢复', archived: '已归档，不再出现在日常列表和到期复习中', restored: '已恢复到知识库', archivedNotice: '这条知识已归档：不参与到期复习，智能体也不会再拿它考你。', archivedEmpty: '没有归档的知识', archivedEmptyHint: '归档的知识会留在这里，随时可以恢复。', delete: '删除', deleteTitle: '删除这条知识？', deleteConfirm: '确认删除', deleteWarning: '「{{title}}」以及它的录音记录和测验留档会一并删除，不可恢复。', deleteArchiveHint: '只是暂时不想学？改用归档，内容会完整保留。',
  ...
  admin: {
    ...
    users: {
      ...
      unban: '解封',
      banTitle: '封禁用户',
      banMessage: '确定封禁 {{name}} 吗？封禁后其全部登录会话将立即失效。',
      unbanTitle: '解封用户',
    ...
    pricing: {
      title: '模型定价',
      subtitle: '维护各模型的 token 计费单价；未配置的模型回退服务端默认价。',
      add: '新增定价',
      createTitle: '新增模型定价',
      editTitle: '编辑模型定价',
      model: '模型名称',
      ...
      deleteTitle: '删除模型定价',
      deleteMessage: '确定删除 {{name}} 的定价吗？删除后该模型计费回退服务端默认价。',
    ...
    configs: {
      title: '功能模型配置',
      subtitle: '为每个功能设置主模型与兜底模型；未启用时继续使用环境变量配置',
      ...
      apiStyleChat: '对话接口 /chat/completions（messages+modalities，OpenAI 官方）',
      apiStyleChatPrompt: '对话接口 /chat/completions（prompt 参数，聚合网关如 okinto）',
      apiStyleResponses: 'Responses 接口 /responses',
      apiStyleDashscopeAsr: 'DashScope 录音转写 /services/audio/asr/transcription',
