...
export default {
  ...
  profile: {
    ...
    emailReminders: {
      ...
      previewTitle: 'HTML 邮件效果预览',
      safePreview: '安全预览',
      previewSubject: '你的邮件主题会显示在这里',
      previewMessage: '想说的话会排版成清晰的 HTML 邮件。',
      htmlSafetyHint: '邮件由系统模板渲染；输入内容始终按纯文本安全处理，不会执行 HTML 或脚本。',
      create: '创建定时任务',
      creating: '正在创建…',
      created: '定时邮件已创建',
