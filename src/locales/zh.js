...
export default {
  ...
  blog: {
    ...
    pureReadingHint: '纯净阅读模式 (按 Esc 退出)',
    tagLabel: '标签',
    popularTags: '热门标签',
    viewAllTags: '全部标签',
    allTags: '全部标签',
    ...
    edit: '编辑',
    preview: '预览',
    noContent: '尚未输入内容', draftRestored: '已恢复上次草稿', draftAutoSaved: '草稿已自动保存', draftDismiss: '关闭提示',
    ...
    editor: { toolbar: '写作工具', addBlock: '添加内容块', text: '文本', h1: 'H1', h2: 'H2', todo: '待办', list: '列表', quote: '引用', code: '代码', insertContent: '插入内容', imageGif: '图片 / GIF', video: '视频（即将支持）', divider: '分割线', table: '表格', codeBlock: '代码块', quoteBlock: '引用块', characters: '{{count}} 字数', lines: '{{count}} 行数', markdownFormat: 'Markdown 格式', previewMode: '预览模式' },
    agent: {
  ...
  blogPlans: {
    ...
    aiGenerateDesc: '输入主题方向，AI 将按天拆分主题，从明天起每天同一时刻自动生成并发布一篇',
    aiSeed: '主题方向',
    aiSeedPlaceholder: '例如：每天一篇 Kubernetes 实战',
    generatedPlans: '已生成 {{count}} 个计划',
    generateFailed: 'AI 生成计划失败，请重试',
    oneShot: '一次性',
    oneShotHint: '每个计划只在计划时间执行一次，发布后自动完结',
    statusFinished: '成功',
    loadFailed: '计划加载失败',
    saveFailed: '保存失败，请重试',
    created: '计划已创建',
    ...
    deleteConfirm: '确定删除计划「{{topic}}」吗？此操作不可恢复。',
    actionFailed: '操作失败，请重试',
    triggered: '已触发，文章开始生成',
    triggerFailed: '触发失败，请检查计划状态',
    paused: '计划已暂停',
    resumed: '计划已恢复',
    cancelled: '计划已取消',
    empty: '还没有定时发文计划',
    emptyHint: '点击右上角「新建计划」，设置主题和每日触发时间',
    topic: '文章主题',
    topicPlaceholder: '例如：Kubernetes 零基础入门',
    topicRequired: '请输入文章主题',
    triggerTime: '每日触发时间',
    timeInvalid: '触发时间格式应为 HH:mm',
    addTime: '添加时段',
    removeTime: '移除时段',
    timesMaxHint: '最多支持 5 个时段',
    topicsQueue: '主题队列',
    topicsHint: '每天按顺序使用一个主题，用完后从头循环',
    topicsQueueUnit: ' 个',
    days: '计划天数',
    generateTopics: 'AI 生成主题',
    topicsGenerated: '已生成 {{count}} 个主题',
    topicsGenerateFailed: '主题生成失败，请重试',
    topicQueuePlaceholder: '输入主题，如：Docker 网络入门',
    removeTopic: '移除主题',
    topicQueueEmpty: '未设置主题队列，每天使用主主题',
    addTopic: '添加主题',
    timezone: '时区',
    audience: '目标读者',
    audiencePlaceholder: '例如：对 Docker 感兴趣的开发者（可选）',
    tone: '文风语气',
  ...
  profile: {
    ...
    account: {
      title: '已登录账户',
      description: '查看并编辑你的账户信息',
      nickname: '昵称',
      nicknamePlaceholder: '请输入昵称',
      nicknameRequired: '请输入昵称',
      avatar: '头像',
      avatarHint: '支持 JPG / PNG / GIF，不超过 2MB',
      avatarInvalid: '头像格式或大小不符合要求',
      username: '用户名',
      email: '邮箱',
      role: '角色',
      memberSince: '加入时间',
    ...
    mcp: {
      ...
      authorize: '授权 MCP',
      endpointsTitle: 'MCP 连接地址',
      blogEndpoint: '本站 MCP',
      csdnEndpoint: 'CSDN MCP',
      juejinEndpoint: '掘金 MCP',
      dualEndpoint: '双端发布 MCP',
      consentTitle: 'MCP 客户端授权',
      consentDescription: '客户端「{{client}}」请求访问以下能力。确认后，它将只能操作当前账号拥有的内容。',
      consentApprove: '批准授权',
      consentDeny: '拒绝',
    ...
    juejin: {
      title: '掘金自动同步',
      description: '绑定掘金账号后，支持将文章一键同步发布至掘金。',
      authorized: '掘金已连接',
      checking: '正在检查连接状态...',
      generatingQr: '正在生成掘金登录二维码...',
      startFailed: '无法发起掘金授权',
      disconnected: '掘金已断开连接',
      disconnectFailed: '无法断开掘金连接',
      qrAlt: '掘金登录二维码',
      scanHint: '使用掘金 App 或扫码授权。二维码将会在短时间内失效。',
      waiting: '等待授权中',
      expired: '二维码已过期，请重新获取',
      queued: '排队等待中',
      queuePosition: '当前排在第 {{position}} 位',
  ...
  img2three: {
    ...
    uploadHint: '拖拽图片到此处，或点击选择文件',
    chooseImage: '选择图片',
    generate: '生成三维场景',
    generating: '正在生成…',
    restoring: '正在恢复任务…',
    stageAnalyze: '正在观察参考图与主体结构',
    stageSpec: '正在生成受限场景规格',
    stageFactory: '正在整理可下载的 TypeScript 工厂',
    ready: '场景已就绪',
    failed: '生成失败',
    downloadSpec: '下载 spec.json',
    downloadFactory: '下载 createModel.ts',
    downloadGlb: '下载 GLB',
    exportingGlb: '正在导出 GLB…',
    reference: '参考图',
    preview: '三维预览',
    previewFailed: '三维预览加载失败',
    attribution: '基于 img2threejs — 在 GitHub 查看',
    loginRequired: '生成并保存任务需要先登录。',
    invalidImage: '请选择 JPEG、PNG、WebP 或 GIF 图片',
    fileTooLarge: '图片不能超过 10MB',
    dropHint: '支持 JPG、PNG、WebP、GIF，单张最大 10MB',
    newTask: '新建任务',
    history: '生成历史',
