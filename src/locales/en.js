...
export default {
  ...
  admin: {
    ...
    configs: {
      ...
      apiStyleChat: 'Chat API /chat/completions',
      apiStyleResponses: 'Responses API /responses',
      apiStyleHint: 'The same model may use different API shapes per provider; choose the chat API for image generation (gpt-image family)',
