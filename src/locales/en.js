...
export default {
  ...
  blog: {
    ...
    agent: {
      ...
      processing: 'Processing {{duration}}', processed: 'Processed {{duration}}', processedDone: 'Processed', processFailed: 'Processing failed', openPreview: 'Click to preview', previewEmpty: 'Select a generated blog on the left to preview', untitled: 'Untitled article', newTask: 'New task', restoring: 'Restoring agent task…', singleTurnHint: 'This turn is done. Start a new task to write another article.', inputLockedPlaceholder: 'This turn has ended. Start a new task.', confirmPublish: 'Publish', viewArticle: 'View article', showMeta: 'Show research and review details', hideMeta: 'Hide research and review details'
    }
  },
  common: {
