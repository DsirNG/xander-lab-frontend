...
export default {
  ...
  profile: {
    ...
    subtitle: 'Manage your account and automated reminders',
    open: 'Open personal center',
    account: 'Signed-in account',
    emailReminders: {
      title: 'Scheduled Email',
      taskList: 'Email task list',
      ...
      emptyHint: 'Write your message and choose a delivery time on the right.',
      ...
      previewTitle: 'HTML email preview',
      safePreview: 'Safe preview',
      previewSubject: 'Your email subject appears here',
      previewMessage: 'Your message will be presented in a clean HTML email.',
      htmlSafetyHint: 'The system template renders the email. Your input stays plain text, so HTML and scripts are never executed.',
