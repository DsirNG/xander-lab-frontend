...
export default {
    ...
    blog: {
        ...
        agentSkills: {
            title: "Skills",
            subtitle:
                "Instructions you write for the agent: no new capabilities, just how it should approach this kind of work",
            create: "New skill",
            emptyTitle: "No skills yet",
            emptyHint:
                "Write down the approach you keep repeating and the agent will follow it from now on",
            loadFailed: "Failed to load skills, please try again later",
            columnSkill: "Skill",
            ...
            newVersionTitle: "New version of {{key}}",
            nonExecutableHint:
                "A skill is only an instruction: it adds no new tools or data sources and cannot bypass approval policies.",
            fieldKey: "Skill key",
            fieldKeyHint:
                "Lowercase letter first, then letters, digits and hyphens; cannot be changed later",
            fieldName: "Name",
            fieldNamePlaceholder: "e.g. Release notes",
            fieldDescription: "When to read it",
            fieldDescriptionHint:
                "One line describing the situation; the agent uses it to decide whether to load this skill",
            fieldInstructions: "Instructions",
            fieldInstructionsHint:
                "Steps and boundaries for the model, up to 12000 characters",
            fieldTools: "Usual tools",
            fieldToolsHint:
                "Optional. A hint about which tools this kind of work uses; it does not restrict actual calls",
            fieldToolsEmpty: "No tools available",
            fieldToolsSelected: "{{count}} selected",
            formKeyInvalid:
                "Skill key must start with a lowercase letter and contain only lowercase letters, digits and hyphens",
            formNameRequired: "Please enter a name",
            formNameTooLong: "Name must be at most {{max}} characters",
            formDescriptionRequired: "Please describe when to use it",
            formDescriptionTooLong:
                "Description must be at most {{max}} characters",
            formInstructionsRequired: "Please enter the instructions",
    ...
    blogPlans: {
        triggerTimeInfo: "Daily trigger time ⓘ",
        tomorrow: "(Tomorrow)",
        tags: {
            autoGenerate: "Auto-generated",
            contentGen: "Content generation",
            manualWrite: "Manually written",
            techPractice: "Technical practice",
        },
        keys: {
            design: "Design",
        },
    ...
    profile: {
        ...
        blogManage: {
            ...
            platformWechat: "WeChat Official Account",
    ...
    knowledgeBase: {
        ...
        folders: {
            ...
            all: "All documents",
            empty: "No folders yet — create one with the button above",
            createTitle: "New folder",
            renameTitle: "Rename folder",
            moveTitle: "Move folder",
            moveAction: "Move to",
            nameLabel: "Folder name",
            namePlaceholder: "e.g. Machine learning, Frontend standards",
            ...
            root: "Root",
            noValidTarget: "No valid destination folder",
        },
        files: {
            searchPlaceholder: "Search document names...",
            allStatuses: "All knowledge statuses",
            recursive: "Include documents in subfolders",
            viewGrid: "Grid view",
            viewList: "List view",
            ...
            charCount: "Extracted characters",
            ...
            moveTitle: "Move file to a folder",
        },
        upload: {
            btn: "Upload document",
            ...
            success: "File uploaded and stored",
            unsupportedExt: "This file type is not supported",
            tooLarge: "File is too large (50 MB max)",
        },
        viewer: {
            title: "Knowledge structure preview",
            tabStructure: "Knowledge map",
            tabChapters: "Chapter outline and text",
            tabInfo: "File properties and tags",
            regenerate: "Regenerate map",
            regenerateSuccess: "Mind map regenerated",
            chapterGenSuccess: "Chapter map generated",
            reidentifySuccess: "Re-analysis complete",
            reidentifyBtn: "Re-parse chapters and text",
            rawFile: "Source file",
            ...
            genChapterMindmap: "Generate chapter map",
        ...
        tags: {
            ...
            create: "New tag",
            addBtn: "New tag",
            createTitle: "New tag entry",
            nameLabel: "Tag name",
            namePlaceholder: "e.g. Architecture, Product design",
            colorLabel: "Tag colour",
            descLabel: "Description (optional)",
            descPlaceholder: "A note to help you remember what this tag is for",
            typeAndEnter: "Type a tag and press Enter",
            attached: "Tag added",
    ...
    blogManage: {
        createNew: "New post",
        performance: "Publishing performance",
        recent7Days: "Last 7 days",
        searchPlaceholder: "Search post title, content or tags",
        stats: {
            all: "All posts",
