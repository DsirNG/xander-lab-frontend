...
export default {
  ...
  profile: {
    ...
    comingSoon: 'Bientôt disponible',
    comingSoonHint: 'Ce module est en préparation. Vous pouvez déjà gérer les rappels avec l’e-mail programmé.',
    nav: {
    ...
    emailReminders: {
      ...
      plainContentHint: 'Le texte brut est mis en page dans le modèle choisi ; les retours à la ligne sont conservés.',
      htmlContentHint: 'Le HTML est rendu dans le modèle choisi ; scripts et balises risquées sont filtrés.',
      plainPreviewBadge: 'Texte brut',
      htmlPreviewBadge: 'Rendu HTML',
      htmlSafetyHint: 'Prend en charge le texte brut et le HTML, avec plusieurs modèles.',
