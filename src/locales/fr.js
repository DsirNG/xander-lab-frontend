...
export default {
  ...
  profile: {
    ...
    subtitle: 'Gérez votre compte et vos rappels automatiques',
    open: 'Ouvrir l’espace personnel',
    account: 'Compte connecté',
    emailReminders: {
      title: 'E-mail programmé',
      taskList: 'Liste des e-mails',
      ...
      emptyHint: 'Écrivez votre message et choisissez une heure d’envoi à droite.',
      ...
      previewTitle: 'Aperçu de l’e-mail HTML',
      safePreview: 'Aperçu sécurisé',
      previewSubject: 'L’objet de votre e-mail apparaîtra ici',
      previewMessage: 'Votre message sera présenté dans un e-mail HTML clair.',
      htmlSafetyHint: 'Le modèle système génère l’e-mail. Votre saisie reste en texte brut : aucun HTML ni script n’est exécuté.',
