...
export default {
  ...
  admin: {
    ...
    configs: {
      ...
      formUntypedWhileEnabled: 'Impossible de renseigner fournisseur ou modèle si le routage est désactivé',
      formPrimaryRequired: 'Un fournisseur principal est requis si le routage est activé',
      formModelRequired: 'Fournisseur et nom de modèle doivent être renseignés ensemble',
