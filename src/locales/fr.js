...
export default {
  ...
  blog: {
    ...
    media: { insertImage: 'Insérer une image', dropImage: 'Déposez ou choisissez une image / un GIF, puis insérez-le au curseur.', uploadingImage: 'Importation', imageInserted: 'Image insérée dans l’article', imageUploadFailed: 'Impossible d’importer l’image. Réessayez.', invalidImage: 'Choisissez une image ou un GIF', imageTooLarge: 'Les images doivent faire 10 Mo maximum', altText: 'Description de l’image', addToArticle: 'Insérer dans l’article' },
    editor: { addBlock: 'Ajouter un bloc', text: 'Texte', h1: 'H1', h2: 'H2', todo: 'Tâche', list: 'Liste', quote: 'Citation', code: 'Code', insertContent: 'Insérer du contenu', imageGif: 'Image / GIF', video: 'Vidéo (bientôt)', divider: 'Séparateur', table: 'Tableau', codeBlock: 'Bloc de code', quoteBlock: 'Bloc de citation' },
    agent: {
      title: 'Agent de blog', back: 'Retour au blog', headline: 'Transformez une idée en article publiable', description: 'Saisissez un thème ou un journal. L’agent recherche, rédige et vérifie un article avec ses sources.', inputLabel: 'Votre thème ou journal', inputPlaceholder: 'Décrivez votre idée, votre expérience ou votre réflexion…', inputType: 'Type de saisie', audience: 'Public', tone: 'Ton', defaultAudience: 'Lecteurs intéressés par ce sujet', defaultTone: 'Clair, sincère et pratique', generate: 'Rechercher et rédiger', running: 'Recherche et rédaction…', waiting: 'En attente de votre saisie', ready: 'Prêt à relire', failed: 'L’agent n’a pas terminé cette tâche', complete: 'Article prêt à être relu', workflow: 'Flux de l’agent', guardrail: 'Les expériences personnelles restent attribuées à leur auteur. Les affirmations externes doivent avoir une source traçable et ne sont jamais publiées automatiquement.', stages: { analyze: 'Cadrer l’article', research: 'Rechercher et vérifier', write: 'Rédiger l’article', review: 'Relire avant publication' }, stageDescriptions: { analyze: 'Définit le lecteur, l’angle et les manques.', research: 'Vérifie les affirmations externes sur le web.', write: 'Produit un article Markdown complet.', review: 'Vérifie les preuves et la clarté.' }, article: 'Article généré', toDraft: 'Ouvrir dans l’éditeur', draftCreated: 'Brouillon créé. Vous pouvez le modifier et le publier.', sources: 'Sources de recherche', noSources: 'Aucune source externe conservée.', review: 'Révision éditoriale', reviewPending: 'La révision apparaîtra une fois le travail terminé.', inputRequired: 'Saisissez d’abord un thème ou un journal.', contentFocus: 'Périmètre du contenu', mustCover: 'Sujet principal', relatedExpansion: 'Extensions directes', outOfScope: 'Non développé', knowledgeGraph: 'Graphe de connaissances'
    }
  },
  common: {
