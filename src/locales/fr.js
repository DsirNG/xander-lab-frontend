...
export default {
  ...
  blog: {
    ...
    editor: { toolbar: 'Outils d’écriture', addBlock: 'Ajouter un bloc', text: 'Texte', h1: 'H1', h2: 'H2', h3: 'H3', todo: 'Tâche', list: 'Liste', orderedList: 'Liste ordonnée', quote: 'Citation', code: 'Code', insertContent: 'Insérer du contenu', imageGif: 'Image / GIF', video: 'Vidéo (bientôt)', divider: 'Séparateur', table: 'Tableau', codeBlock: 'Bloc de code', quoteBlock: 'Bloc de citation', bold: 'Gras', italic: 'Italique', strike: 'Barré', addLink: 'Ajouter un lien', linkPrompt: 'Saisissez l’URL du lien, laisser vide pour retirer', undo: 'Annuler', redo: 'Rétablir', clearFormatting: 'Effacer la mise en forme', insertTable: 'Insérer un tableau' },
    agent: {
