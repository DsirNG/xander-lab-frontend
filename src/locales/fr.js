...
export default {
  ...
  admin: {
    ...
    configs: {
      ...
      apiStyleHint: 'Un même modèle peut utiliser des formes d\'API différentes selon le fournisseur ; choisissez l\'API chat pour la génération d\'images (famille gpt-image)',
