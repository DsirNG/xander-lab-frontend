...
export default {
  ...
  blog: {
    ...
    agent: {
      ...
      processing: 'Traitement {{duration}}', processed: 'Traité {{duration}}', processedDone: 'Traité', processFailed: 'Échec du traitement', openPreview: 'Cliquer pour prévisualiser', previewEmpty: 'Sélectionnez un article généré à gauche pour prévisualiser', untitled: 'Article sans titre', newTask: 'Nouvelle tâche', restoring: 'Restauration de la tâche…', singleTurnHint: 'Ce tour est terminé. Commencez une nouvelle tâche pour écrire un autre article.', inputLockedPlaceholder: 'Ce tour est terminé. Commencez une nouvelle tâche.', confirmPublish: 'Publier', viewArticle: 'Voir l’article', showMeta: 'Afficher recherche et révision', hideMeta: 'Masquer recherche et révision'
    }
  },
  common: {
