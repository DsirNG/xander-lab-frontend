                ...
                <div className="flex items-center space-x-2 flex-shrink-0">
                    ...
                    {item.detailPages && item.detailPages.length > 0 && (
                        <Link
                            ...
                            className="flex items-center space-x-2 bg-slate-900  text-white  px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl sm:rounded-2xl font-bold text-xs sm:text-sm hover:scale-105 transition-transform shadow-xl whitespace-nowrap"
                        >
