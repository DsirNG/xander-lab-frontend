...
describe('timezones', () => {
  ...
  it('computes the current offset label for a known zone', () => {
    const label = getZoneOffsetLabel('Asia/Shanghai', new Date('2026-01-15T12:00:00Z'))
  ...
  it('reflects daylight saving transitions for DST zones', () => {
    const summer = getZoneOffsetLabel('Europe/Paris', new Date('2026-07-15T12:00:00Z'))
    const winter = getZoneOffsetLabel('Europe/Paris', new Date('2026-01-15T12:00:00Z'))
