...
describe("Pagination", () => {
    ...
    it("renders the page info summary", () => {
        ...
        expect(
            screen.getByText(/common\.pagination\.pageInfo/),
        ).toBeInTheDocument();
    });
    ...
    it("calls onPageChange with page-1 on prev and page+1 on next", () => {
        ...
        fireEvent.click(
            screen.getByRole("button", { name: /prevPage|上一页|prev/i }),
        );
        expect(onPageChange).toHaveBeenLastCalledWith(2);
        fireEvent.click(
            screen.getByRole("button", { name: /nextPage|下一页|next/i }),
        );
    ...
    it("disables prev on the first page and next on the last page", () => {
        ...
        expect(
            screen
                .getAllByRole("button", { name: /nextPage|下一页|next/i })
                .at(-1),
        ).toBeDisabled();
    });
