    ...
    generateStructure() {
        ...
        this.addUrl("/", {
            ...
            image: {
                ...
                caption:
                    "Cutting-edge UI infrastructure systems and interactive components platform",
            },
        });
        ...
        // 基础设施详情页
        this.addUrl("/infra/positioning-system", {
            changefreq: "monthly",
            priority: 0.8,
        });
        this.addUrl("/infra/drag-drop-system", {
            changefreq: "monthly",
            priority: 0.8,
        });

        // 功能模块详情页
        this.addUrl("/modules/drag-drop", {
            changefreq: "monthly",
            priority: 0.8,
        });
        this.addUrl("/modules/anchored-overlay", {
            changefreq: "monthly",
            priority: 0.8,
        });
...
// 导出供其他模块使用
export { SEOTools, SitemapGenerator, SearchEngineSubmitter, Logger };
